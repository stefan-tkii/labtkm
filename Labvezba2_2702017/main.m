...
Dtime = 0.1;                                    % normalized propagation delay
...
capture = 1;                                    % capture effect  0:nothing  1:consider
spend   = 1000;                                 % number of packets that simulation is finished
...
for G=[0.1:0.1:1,2:1:10]                     % offered traffic
    if G >= Mnum
        break
    end
